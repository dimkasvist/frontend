...
import { Home, Grid, Plus, Bell, Settings, Sun, Moon, Snowflake } from 'lucide-react';
    ...
    <aside className="fixed left-0 top-0 h-screen w-20 bg-[var(--header-bg)] border-r border-[var(--border-color)] flex flex-col items-center py-4 z-40">
      ...
      <nav className="flex-1 flex flex-col items-center gap-2 w-full px-2">
        ...
        <button
          ...
          className="w-12 h-12 rounded-full flex items-center justify-center bg-red-500 hover:bg-red-600 text-white transition-colors mt-2"
          title="Создать"
        >
      ...
      <div className="flex flex-col items-center gap-2 w-full px-2">
        <div className="relative" ref={notificationsRef}>
          <button
            ...
            className="relative w-12 h-12 rounded-full flex items-center justify-center hover:bg-[var(--input-bg)] text-[var(--foreground)] transition-colors"
            title="Уведомления"
          >
